...
/////Endereco Ferias
        ...
        if (escolaprov != null) {
            ...
            while (itemsescolaProv.hasNext()) {
                ...
                if (((Provincia) citescolaProv.getValue()).getIdProvincia() == escolaprovincia) {
...
//        else{
//        //    cbcurso.removeAttribute("onAfterRender");
//            Clients.showNotification("O utilizador deve pertencer a uma Faculdade especifica", "warning", null, null, 0);
//          
//        }
        return null;
    }
